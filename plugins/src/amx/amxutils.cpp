...
std::unordered_map<AMX*, std::shared_ptr<amx::Instance>> handle_map;

std::shared_ptr<amx::Instance> amx::GetHandle(AMX *amx)
{
	...
	return handle_map[amx] = std::make_shared<amx::Instance>(amx);
}
